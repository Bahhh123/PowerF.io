...
(strpos($session,  "Your transaction was declined due to insufficient funds in your account. Please use a different card or contact your bank.")) {
  echo "<font size=2 color='white'>  <font class='badge badge-info'>Approved🟢 ⍋ $cc|$mes|$ano|$cvv </span></i></font> <br> <font size=2 color='red'><font class='badge badge-light'>Insufficient Funds [ WOLFIE] $detail </i></font><br> <font class='badge badge-primary'>$bank [$country] - $type</i></font><br>";
}


else {
  echo "<font size=2 color='white'>  <font class='badge badge-danger'> Declined🔴 ⍋ $cc|$mes|$ano|$cvv </span></i></font> <br> <font size=2 color='red'><font class='badge badge-light'>$detail // [ WOLFIE]  </i></font><br> <font class='badge badge-primary'>$bank [$country] - $type</i></font><br> ";
}
